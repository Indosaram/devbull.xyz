...
Can you solve this real interview question? Last Person to Fit in the Bus - Table: Queue +-------------+---------+| Column Name | Type |+-------------+---------+| person\_id | int || person\_name | varchar || weight | int || turn | int |+-------------+---------+p…

![](https://leetcode.com/favicon.ico)LeetCode

![](https://leetcode.com/static/images/LeetCode_Sharing.png)](https://leetcode.com/problems/last-person-to-fit-in-the-bus/)
...
| sale\_id | sale\_amount | cumulative\_sum |
| --- | --- | --- |
| 1 | 100 | 100 |
| 2 | 200 | 300 |
| 3 | 300 | 600 |
